...
module.exports = {
  up: (queryInterface: QueryInterface) => {
    return queryInterface.sequelize.query(`
      ...
      INSERT INTO public."Settings" ("key", value, "createdAt", "updatedAt", "tenantId", id) VALUES('ticketAction', 'new', '2020-12-12 16:08:45.354', '2022-07-01 21:10:02.076', 1, 11);
      INSERT INTO public."Settings" ("key", value, "createdAt", "updatedAt", "tenantId", id) VALUES('manterHistorico', 'disabled', '2020-12-12 16:08:45.354', '2020-12-12 16:08:45.354', 1, 12);
    `);
  },
